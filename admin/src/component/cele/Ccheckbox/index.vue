<template>
	<div class="c_checkbox" :class="{'on':defaultChecked}" @click="handleChecked">
	        <div class="c_checkbox_box" :class="{'circle':type=='circle'||type=='1'}"><input type="checkbox" :name="name" :value="value" class="unvisible" :disabled="disabled" :checked="defaultChecked"></div>
